%_eg_conditional_dropds(WORK.META4_2014);

PROC SQL;
   CREATE TABLE WORK.META4_2014 AS 
   SELECT t1.NU_ANO_CENSO, 
      ...
      WHERE t1.TP_TIPO_ATENDIMENTO_TURMA IN 
           ...
           1,
           2
           ) AND t1.NU_IDADE_REFERENCIA BETWEEN 4 AND 17 AND t1.IN_NECESSIDADE_ESPECIAL = 1 AND t1.NU_ANO_CENSO = 2014
